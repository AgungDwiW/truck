...
$sql_nopol = mysqli_query($con,"  SELECT * from tbm_user where nama='$username' ");
...
<div class="row justify-content-md-center">
  ...
  <div class="col">
        ...
        <input type="text" class="form-control text-uppercase" id="driver" name="driver" required >
  </div>
  </br>
  <div class="col">
      ...
      <select class="form-control text-uppercase" id="supplier">
