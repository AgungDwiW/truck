<?php
/**
 * Main Landing Page – Driver & Helper Registration
 * 
 * This page serves as the entry point for the inspection workflow.
 * It guides the user through three steps:
 *   1. Confirm driver/helper registration status.
 *   2. Select the type of cargo (FG or Material).
 *   3. Choose the gate to proceed to.
 */
...
<!-- Step 1: Driver & Helper Registration Status -->
