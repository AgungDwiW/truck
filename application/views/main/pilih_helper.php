...
mysqli_query($con,"INSERT INTO tb_vaksin SET pengendara='$orang', nama='$nama_driver', nik_8_digit_awal='$nik', nama_transporter='$nama_trans', status_vaksin='$dosis',plant_name='$plant_name' ");
...
<div class="row" >
    ...
    <input type="text" class="form-control" id="nama_driver" name="nama_driver" placeholder="Nama Helper (Sesuai KTP)" >
    </div>
